...
+ (NSURLRequest *)urlRequestWithPath:(NSString *)path withVersion:(SHHostVersion)hostVersion withParams:(NSArray *)params withMethod:(NSString *)method withHeaders:(NSDictionary *)headers withBodyOrStream:(id)body_or_stream
{
    ...
    BOOL needAddInstallId = ([completeUrl.lowercaseString hasPrefix:@"https://api.streethawk.com"] || [completeUrl.lowercaseString hasPrefix:@"https://dev.streethawk.com"]) && !shStrIsEmpty(StreetHawk.currentInstall.suid);
    ...
    else
    {
            ...
            [contentType hasPrefix:@"text/json"])
        {
            ...
            if (dict != nil && [dict isKindOfClass:NSDictionary.class])
            {
                ...
                if ([theConnection.currentRequest.URL.absoluteString hasPrefix:@"https://api.streethawk.com"] || [theConnection.currentRequest.URL.absoluteString hasPrefix:@"https://dev.streethawk.com"])
                {
